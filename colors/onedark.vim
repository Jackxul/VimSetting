...
let s:colors = {
      ...
      \ "pale_green"	: get(s:overrides, "pale_green", { "gui": "#AFFF87", "cterm": "156", "cterm16": "4" }),
      ...
      \ "orange"	: get(s:overrides, "orange", { "gui": "#D78700", "cterm": "172", "cterm16": "8" }),
      \ "plum"		: get(s:overrides, "plum", { "gui": "#D7AFFF", "cterm": "183", "cterm16": "9" }),
      \ "steel_blue"	: get(s:overrides, "steel_blue", { "gui": "#D7D7FF", "cterm": "189", "cterm16": "9" }),
...
call s:h("String", { "fg": s:colors.white }) " a string constant: "this is a string"
call s:h("Character", { "fg": s:colors.green }) " a character constant: 'c', '\n'
call s:h("Number", { "fg": s:colors.yellow }) " a number constant: 234, 0xff
...
call s:h("LineNr", { "fg": s:colors.steel_blue  }) " Line number for ":number" and ":#" commands, and when 'number' or 'relativenumber' option is set.
...
call s:h("Normal", { "fg": s:colors.cyan , "bg": s:colors.black }) " normal text
...
call s:h("cType", { "fg": s:colors.pale_green })
...
call s:h("cppType", { "fg": s:colors.pale_green })
